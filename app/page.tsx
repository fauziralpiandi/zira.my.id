  ...
  return (
    <>
      ...
      <section>
        ...
        <p>
          Trying out fresh ideas &amp; techniques, hunting for fresh libraries
          &amp; tools, pushing myself to get the hang of best practices while
          crafting killer user experience&mdash;
        </p>

        <p>
          Every line of code weaves a story&mdash; flow, finesse, &amp; fun.
        </p>
      </section>
    </>
  )
