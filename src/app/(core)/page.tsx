  ...
  return (
    <section className="grid min-h-96 place-items-center">
      <div className="flex flex-col items-center gap-2 md:flex-row md:gap-8">
        <figure className="group relative flex aspect-square h-32 w-32 items-center rounded-full">
          <div className="animate absolute inset-0 rounded-full bg-stone-500 blur-3xl group-hover:bg-primary" />
          <Image
            ...
            className="animate rounded-full object-cover grayscale group-hover:grayscale-0"
          />
        </figure>
