...
const ContactForm = (): React.ReactElement => {
  ...
  return (
    <div className="relative mx-auto max-w-2xl p-8 bg-neutral-900 border border-dashed border-neutral-500 shadow-lg rounded-xl">
      ...
      <p className="mb-6 font-medium text-center text-sm text-neutral-400 leading-snug">
        I&rsquo;d love to hear from you. Fill out the form below to get in touch!
      </p>
      <form
        onSubmit={(e) => {
          e.preventDefault()
