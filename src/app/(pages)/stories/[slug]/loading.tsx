export default function Loading() {
  return (
    <section>
      ...
      <div className="relative right-[50%] left-[50%] my-8 aspect-2/1 w-screen translate-x-[-50%] animate-pulse bg-neutral-900 md:aspect-21/9 md:max-w-2xl md:rounded-lg" />
